...
"}")
        ...
        self.frame.setGeometry(QRect(-10, 0, 1331, 81))
...
"")
        ...
        self.horizontalFrame.setGeometry(QRect(20, 0, 1141, 80))
...
"}")
        ...
        self.passLineEdit = QLineEdit(self.horizontalWidget_3)
        self.passLineEdit.setObjectName(u"passLineEdit")
        sizePolicy1.setHeightForWidth(self.passLineEdit.sizePolicy().hasHeightForWidth())
...
"	padding: 4px;\n"
"}")
        self.passLineEdit.setMaxLength(16)
...
"}")
        ...
        self.formLayout.setWidget(6, QFormLayout.ItemRole.LabelRole, self.PassLabel)

        self.PassLineEdit = QLineEdit(self.formFrame)
        self.PassLineEdit.setObjectName(u"PassLineEdit")
        sizePolicy1.setHeightForWidth(self.PassLineEdit.sizePolicy().hasHeightForWidth())
        self.PassLineEdit.setSizePolicy(sizePolicy1)
...
"}")
        self.PassLineEdit.setMaxLength(16)
        self.PassLineEdit.setCursorPosition(14)

        self.formLayout.setWidget(6, QFormLayout.ItemRole.FieldRole, self.PassLineEdit)
...
"}")
    ...
    def retranslateUi(self, SecureVote):
        SecureVote.setWindowTitle(QCoreApplication.translate("SecureVote", u"MainWindow", None))
        ...
        self.passLabel.setText(QCoreApplication.translate("SecureVote", u"Password:", None))
        ...
        self.PassLabel.setText(QCoreApplication.translate("SecureVote", u"Password:", None))
        self.PassLineEdit.setText(QCoreApplication.translate("SecureVote", u"12345678912345", None))
